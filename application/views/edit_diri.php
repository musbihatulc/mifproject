    ...
    <div class="form-group">
    <input type="text" class="form-control form-control-user" value="<?php echo $dataku->Alamat; ?>" id="Alamat" name="Alamat" 
    placeholder="Alamat" >
    </div> 
    <div class="form-group">
    <input type="text" class="form-control form-control-user" value="<?php echo $dataku->TTL; ?>" id="TTL" name="TTL" 
    placeholder="TTL"> 
    </div>
    <div class="form-group">
    <input type="text" class="form-control form-control-user" value="<?php echo $dataku->Status_pernikahan; ?>" id="Status_pernikahan" name="Status_pernikahan" 
    placeholder="Status"> 
    </div> 
    <div class="form-group">
    <input type="text" class="form-control form-control-user" value="<?php echo $dataku->No_telp; ?>" id="No_telp" name="No_telp" 
    placeholder="No_telp"> 
    </div> 
    <div class="form-group">
